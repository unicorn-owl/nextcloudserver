		...
		<Modal v-if="modal" @close="closeModal">
			<div class="modal__content">
				...
				<BackgroundSettings :background="background"
					:override-default-background="overrideDefaultBackground"
...
const overrideDefaultBackground = loadState('dashboard', 'overrideDefaultBackground')
...
export default {
	...
	computed: {
		backgroundImage() {
			return getBackgroundUrl(this.background, this.version, this.overrideDefaultBackground)
		},
		backgroundStyle() {
